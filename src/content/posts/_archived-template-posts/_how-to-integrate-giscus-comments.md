...
接下来，需要配置*Giscus*。在大多数情况下，预选的默认值是合适的，只有在有特定原因并且知道自己在做什么的情况下才应该修改它们。不要太担心做出错误的选择；您以后可以随时调整配置。
...
首先，我们要为*Giscus*安装[React组件](https://www.npmjs.com/package/@giscus/react)：
